package br.com.android.estudos.sunshineapp.sync;
...
import br.com.android.estudos.sunshineapp.R;
import br.com.android.estudos.sunshineapp.Utility;
...
//        String location = intent.getStringExtra(EXTRA_LOCATION);
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter("appid", "e97690e93a6a314bcd82b2c6bc489e42") // my appid
                    .build();
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor!= null && cursor.moveToFirst()) {
            ...
            Uri newLocationUri = contentResolver.insert(locationUri, values);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                int inserted = this.getContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cVArray);
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                notificationManagerCompat.notify(WEATHER_NOTIFICATION_ID, notification);
